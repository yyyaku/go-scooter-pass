...
var _initSliderExclusive = require("./modules/sliders/init-slider-exclusive");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initSliderExclusive.initSliderExclusive)();
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/sliders/init-slider-exclusive":11,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
...
exports.initSliderExclusive = void 0;
var sliderExclusive = document.querySelector('.exclusive__swiper');
var sliderExclusiveList = document.querySelector('.exclusive__list');
var sliderExclusiveCard = document.querySelector('.exclusive__item');
var buttons = document.querySelector('.exclusive__buttons');
var buttonPrev = document.querySelector('.exclusive__button--prev');
var buttonNext = document.querySelector('.exclusive__button--next');
var initSliderExclusive = exports.initSliderExclusive = function initSliderExclusive() {
